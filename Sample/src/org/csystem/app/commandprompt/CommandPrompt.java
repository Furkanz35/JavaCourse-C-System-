...
public class CommandPrompt {
    private static final String [] ms_commend = {"lower", "upper", "reverse", "length", "chgprompt", "quit"};
    ...
    private static int getCommandIndex(String cmd)
    {
        ...
        for (int i = 0; i < ms_commend.length; ++i)
            if (ms_commend[i].startsWith(cmd))
                return i;
